<aside id="layout-menu" class="layout-menu menu-vertical menu" style="background:linear-gradient(90deg, rgba(122, 94, 159, .9) 15%, rgba(49, 70, 145, .85) 51%) !important; color: #fff !important;">
    <div class="app-brand demo ">
        <a href="{{ route('dashboard') }}" class="app-brand-link text-white">
    ...
    <ul class="menu-inner py-1 text-white">
        ...
        <li class="menu-item">
            <a href="{{route('elearning.dashboard')}}" class="menu-link text-white">
                <i class="menu-icon icon-base ti tabler-apps"></i>
                <div data-i18n="Chat">App</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{route('web.dashboard')}}" class="menu-link text-white">
