<aside id="layout-menu" class="layout-menu menu-vertical menu" style="background:linear-gradient(90deg, rgba(122, 94, 159, .9) 15%, rgba(49, 70, 145, .85) 51%) !important; color: #fff !important;">
    <div class="app-brand demo ">
        <a href="<?php echo e(route('dashboard')); ?>" class="app-brand-link text-white">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-3 text-white">Administrador JC </span>
        </a>
    </div>
    <ul class="menu-inner py-1 text-white">
        <li class="menu-item text-white">
            <a href="<?php echo e(route('dashboard')); ?>" class="menu-link text-white">
                <i class="menu-icon icon-base ti tabler-school"></i>
                <div data-i18n="Email">Elearning</div>
            </a>
        </li>
        <li class="menu-item">
...
</aside><?php /**PATH C:\Users\JC-INNOVATION\adminJC\adminJC\resources\views/layouts/aside.blade.php ENDPATH**/ ?>